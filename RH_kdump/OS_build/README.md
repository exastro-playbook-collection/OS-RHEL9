Ansible Role: OS-RHEL9/RH_kdump/OS_build
=======================================================
# Description
本ロールは、RHEL9に関するカーネルダンプ設定についての情報の設定を行います。
...
OS-RHEL9/RH_kdump/OS_gatheringロールを利用します。
...
| ---- | ----------- | 
| `VAR_RH_kdump` | | 
| `- file` | コピー元ファイルkdump.confの情報（ファイル名前またはパス付けファイル名前） | 
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-RHEL9/RH_kdump/OS_gathering
  strategy: free
~~~
