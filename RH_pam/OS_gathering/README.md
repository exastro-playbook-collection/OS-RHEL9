Ansible Role: OS-RHEL9/RH_pam/OS_gathering
=======================================================
# Description
本ロールは、RHEL9に関するパスワード設定についての情報の取得を行います。
...
| ---- | ----------- | 
| `VAR_RH_pam` | | 
| `- file` | コピー元ファイルsystem-authの情報（ファイル名前またはパス付けファイル名前）、収集不可ので常に''(空値)である | 
| &nbsp;&nbsp;&nbsp;&nbsp;`path` | ファイルパス /etc/authselect/system-auth |
| &nbsp;&nbsp;&nbsp;&nbsp;`text` | system-authファイルの内容 | 
| `- file` | コピー元ファイルpassword-authの情報（ファイル名前またはパス付けファイル名前）、収集不可ので常に''(空値)である | 
| &nbsp;&nbsp;&nbsp;&nbsp;`path` | ファイルパス /etc/authselect/password-auth |
| &nbsp;&nbsp;&nbsp;&nbsp;`text` | password-authファイルの内容 | 
| `- file` | コピー元ファイルlogin.defsの情報（ファイル名前またはパス付けファイル名前）、収集不可ので常に''(空値)である | 
