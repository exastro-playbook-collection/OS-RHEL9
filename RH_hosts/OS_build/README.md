Ansible Role: OS-RHEL9/RH_hosts/OS_build
=======================================================
# Description
本ロールは、RHEL9に関するhosts設定についての情報の設定を行います。
...
OS-RHEL9/RH_hosts/OS_gatheringロールを利用します。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-RHEL9/RH_hosts/OS_build
      VAR_RH_hosts:
      - file: hosts
        path: /etc/hosts
        text:
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-RHEL9/RH_hosts/OS_gathering
  strategy: free
~~~
